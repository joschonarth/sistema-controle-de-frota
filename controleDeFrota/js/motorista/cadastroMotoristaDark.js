...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const botaoSubmit = document.getElementById('salvar');
    const personalBorder = document.getElementById('personal-section');
    const cnhBorder = document.getElementById('cnh-section');
    ...
    if (themeSystem === 'dark') {
        ...
        personalBorder.classList.add('bordered-section-dark');
        cnhBorder.classList.add('bordered-section-dark');
        ...
        personalBorder.classList.remove('bordered-section-dark');
        cnhBorder.classList.remove('bordered-section-dark');
        formElements.forEach(element => {
